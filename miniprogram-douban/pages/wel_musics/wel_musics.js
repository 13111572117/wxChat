Page({
  ...
  onLoad(options) {
    // 短平
    wx.request({
      url: "https://douban.uieee.com/v2/music/" + options.newsid,
      method: "GET",
      data: {},
      header: {
        "content-type": "json"
    ...
    // 短影评
    wx.request({
      url: "https://douban.uieee.com/v2/music/" + options.newsid + "/reviews",
      method: "GET",
      data: {},
      header: {
        "content-type": "json"
    ...
    // 长影评
    wx.request({
      url: "https://douban.uieee.com/v2/music/" + options.newsid + "/comments",
      method: "GET",
      data: {},
      header: {
        "content-type": "json"
